...
from pyrevolut.api.common import BaseEndpoint, EnumMerchantCategory
from pyrevolut.utils import DateTime

from .get import RetrieveListOfCards, RetrieveCardDetails, RetrieveSensitiveCardDetails
from .post import CreateCard, FreezeCard, UnfreezeCard
from .patch import UpdateCardDetails
from .delete import TerminateCard


class EndpointCards(BaseEndpoint):
    """The Cards API
    ...
    async def aget_card_sensitive_details(
        self,
        card_id: UUID,
        **kwargs,
    ):

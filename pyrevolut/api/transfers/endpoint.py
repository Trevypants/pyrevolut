...
from .get import GetTransferReasons
from .post import CreateTransferToAnotherAccount, MoveMoneyBetweenAccounts


class EndpointTransfers(BaseEndpoint):
    """The Transfers API
    ...
    async def acreate_transfer_to_another_account(
        self,
        request_id: str,
        account_id: UUID,
        counterparty_id: UUID,
    ...
    async def amove_money_between_accounts(
        self,
        request_id: str,
        source_account_id: UUID,
        target_account_id: UUID,

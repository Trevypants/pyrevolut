...
from .get import RetrieveListOfWebhooks, RetrieveWebhook, RetrieveListOfFailedWebhooks
from .post import CreateWebhook, RotateWebhookSecret
from .patch import UpdateWebhook
from .delete import DeleteWebhook


class EndpointWebhooks(BaseEndpoint):
    """The Webhooks API
    ...
    async def aget_failed_webhook_events(
        self,
        webhook_id: UUID,
        limit: int | None = None,
        created_before: datetime | DateTime | str | int | float | None = None,
    ...
    async def arotate_webhook_secret(
        self,
        webhook_id: UUID,
        expiration_period: Duration | None = None,
        **kwargs,

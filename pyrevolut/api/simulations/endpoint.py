...
from .post import SimulateAccountTopup, SimulateTransferStateUpdate


class EndpointSimulations(BaseEndpoint):
    """The Simulations API
    ...
    async def asimulate_account_topup(
        self,
        account_id: UUID,
        amount: Decimal,
        currency: str,
    ...
    async def asimulate_transfer_state_update(
        self,
        transfer_id: UUID,
        action: EnumSimulateTransferStateAction,
        **kwargs,
